...
ONTDNA_pileup <- read.table("project_results/ONT_DNA_BamHI_BamHI/ONT_DNA_BamHI_BamHI.bam.bed.tsv", header = TRUE, sep="\t", stringsAsFactors=FALSE, quote="")
...
ggplot(kmer_frequency) +
  ...
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_frequency.pdf")
...
ggplot(data.frame(k_total_granges@elementMetadata) %>% arrange(Error_mean)) +
  ...
  xlab("GC percent") +
  ylab("HP length") +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_GC_vs_HP_Error.pdf")
...
ggplot(data.frame(k_total_granges@elementMetadata) %>% arrange(INS_mean)) +
  ...
  xlab("GC percent") +
  ylab("HP length") +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_GC_vs_HP_INS.pdf")
...
ggplot(data.frame(k_total_granges@elementMetadata) %>% arrange(SUB_mean)) +
  ...
  xlab("GC percent") +
  ylab("HP length") +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_GC_vs_HP_SUB.pdf")
...
ggplot(data.frame(k_total_granges@elementMetadata) %>% arrange(DEL_mean)) +
  ...
  xlab("GC percent") +
  ylab("HP length") +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_GC_vs_HP_DEL.pdf")
...
melt(id.vars = 'GC_pct', data = kmer_error_freq %>% 
  ...
  facet_wrap(~variable) +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_error_frequency_w_GC_content.pdf")
...
melt(id.vars = 'HP_length', data = kmer_error_freq %>% 
  ...
  ylab("Error Frequency (log2)") +
  facet_wrap(~variable) +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_error_frequency_w_HP_length.pdf")
...
kmer_error_freq %>%
  ...
  ylab("Error Frequency (log2)") +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank()) +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_Error_frequency.pdf")
...
kmer_error_freq %>%
  ...
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank()) +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_INS_frequency.pdf")
...
kmer_error_freq %>%
  ...
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank()) +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_DEL_frequency.pdf")
...
kmer_error_freq %>%
  ...
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank()) +
  ggsave("project_results/ONT_DNA_BamHI/SynX_kmer_SUB_frequency.pdf")
