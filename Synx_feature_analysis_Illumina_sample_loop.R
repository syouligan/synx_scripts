...
for (ds in digested_data_sets) {
  ...
  ggplot(data.frame(performanceGC@elementMetadata)) +
    ...
    theme_minimal() +
    ggsave(paste0("project_results/", ds, "/SynX_performance_GC_content_", ds, ".pdf"))
  ...
  ggplot(GC_error_long) +
    ...
    ylab('Error rate') +
    theme_classic() +
    ggsave(paste0("project_results/", ds, "/SynX_performance_GC_all_errors_", ds, ".pdf"))
  ...
  ggplot(data.frame(table(synx_hp_ranges$score)), aes(x=Var1, y=log2(Freq))) +
    ...
    ylab("Frequency (log2)") +
    theme_classic() +
    ggsave(paste0("project_results/", ds, "/Homopolymer_synx_total_frequency_", ds, ".pdf"))
  ...
  ggplot(data.frame(table(performanceHP1_ranges$score)), aes(x=Var1, y=Freq)) +
    ...
    ylab("Frequency") +
    theme_classic() +
    ggsave(paste0("project_results/", ds, "/Homopolymer_performance_element1_frequency_total_", ds, ".pdf"))
  ...
  ggplot(data.frame(table(performanceHP2_ranges$score)), aes(x=Var1, y=Freq)) +
    ...
    ylab("Frequency") +
    theme_classic() +
    ggsave(paste0("project_results/", ds, "/Homopolymer_performance_element2_frequency_total_", ds, ".pdf"))
  ...
  for( i in paste0(errors, '_freq')) {
    ggplot(data.frame(performanceHPtot_ranges@elementMetadata), ) +
      ...
      ylab(i) +
      theme_classic() +
      ggsave(paste0("project_results/", ds, "/Homopolymer_error_rate_",  i,"_", ds, ".pdf"))
  }
